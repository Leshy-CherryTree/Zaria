 ...
 */
public class DisconnectUndoAction implements UndoAction<GraphEditorState>
{
	//--------------------------------------------------------------------------
	...
	public DisconnectUndoAction(ZoneGraphInputPort inputPort, ZoneGraphOutputPort outputPort)
	{
	...
	{
		target.undoDisconnect(inputPort, outputPort, type);
	}
