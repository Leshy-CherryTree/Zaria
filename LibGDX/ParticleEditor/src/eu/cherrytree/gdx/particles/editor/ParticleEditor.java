...
public class ParticleEditor extends JFrame
{
	...
	private NumericValue pixelsPerMeter;
	private NumericValue zoomLevel;
	private NumericValue deltaMultiplier;
	private GradientColorValue backgroundColor;

	private float pixelsPerMeterPrev;
	...
	private void initializeComponents()
	{
		...
		}
		{
			...
			leftSplit.setDividerLocation(325);
		}
	...
	class Renderer implements ApplicationListener, InputProcessor
	{
		...
		public void create()
		{
			...
			backgroundColor.setColors(new float[]
			{
				0f, 0f, 0f
			});

			font = new BitmapFont(	Gdx.files.getFileHandle("eu/cherrytree/gdx/particles/editor/res/default.fnt", FileType.Internal),
									Gdx.files.getFileHandle("eu/cherrytree/gdx/particles/editor/res/default.png", FileType.Internal), true);
